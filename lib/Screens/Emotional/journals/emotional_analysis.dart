...
class ECheckinController extends GetxController {
  ...
  @override
  void onInit() {
    name.text = 'ERJournalLevel2EmotionalAnalysis${formatTitelDate(DateTime.now()).trim()}';
  ...
  Future addECI([bool fromsave = false]) async {
    ...
    if (page1.currentState!.validate()) {
      ...
      if (!fromsave) {
        if (Get.find<ErController>().history.value.value == 81) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  onTap: () => Get.to(() => const EmotionalAnalysis(),
...
class EmotionalAnalysis extends StatefulWidget {
  ...
  @override
  _EmotionalAnalysisState createState() => _EmotionalAnalysisState();
}
