...
class EAsfController extends GetxController {
  ...
  @override
  void onInit() {
    name.text = 'ERJournalLevel3ThoughtCheckinShortForm${formatTitelDate(DateTime.now()).trim()}';
  ...
  Future addEmotionalCheckin([bool fromsave = false]) async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (!fromsave) {
        if (Get.find<ErController>().history.value.value == 86) {
          RxInt count = 0.obs;
          await erRef
        ...
        } else if (Get.find<ErController>().history.value.value == 85) {
...
class ThoughtCheckinSf extends StatefulWidget {
  const ThoughtCheckinSf({Key? key}) : super(key: key);

  @override
  State<ThoughtCheckinSf> createState() => _ThoughtCheckinSfState();
}

class _ThoughtCheckinSfState extends State<ThoughtCheckinSf> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const TextWidget(
                      text:
                          'ER Journal Level 3 - \nThought Check- In Short Form (Practice)',
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  onTap: () => Get.to(() => const ThoughtCheckinSf(),
